...
InstallOrUpdateModule -module "DosInstallUtilities.Kube" -local $local -minVersion "2.13"

InstallOrUpdateModule -module "DosInstallUtilities.Azure" -local $local -minVersion "2.12"

InstallOrUpdateModule -module "DosInstallUtilities.Menu" -local $local -minVersion "2.12"

InstallOrUpdateModule -module "DosInstallUtilities.Realtime" -local $local -minVersion "2.11"

InstallOrUpdateModule -module "DosInstallUtilities.Nlp" -local $local -minVersion "2.14"
