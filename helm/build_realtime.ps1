...
Write-Host "moving dos-realtime-*.tgz tp releases/"
...
Write-Host "And install realtime via: helm install -f myvalues.yaml dos/dos-realtime --name=realtime"
Write-Host "--------------------------------------------------"
